...
# 两个壳分别可关：只有 Widgets 的 Qt 环境不必安装 Quick/Qml 也能构建 GUI
...
if(UNIDICT_BUILD_QT_APPS OR UNIDICT_BUILD_QT_TESTS)
    if(UNIDICT_ENABLE_EXTERNAL_QT)
        set(_unidict_qt_components Core Gui Network)
        if(UNIDICT_BUILD_QT_QMLUI)
            list(APPEND _unidict_qt_components Qml Quick)
        endif()
        find_package(Qt6 ${QT_MIN_VERSION} COMPONENTS ${_unidict_qt_components} REQUIRED)
    endif()
endif()
